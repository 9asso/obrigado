    ...
    final script = '''
      (function() {
        ...
        function forceHideElement(element, reason) {
          ...
          console.log('🚫 Force hidden:', reason);
        }
        ...
        function closeModal() {
          ...
          const paymentModals = document.querySelectorAll(
            '[data-testid="in-app-form"], ' +
            '.inAppForm, ' +
            '[class*="PaymentsModal"], ' +
            '[class*="drawer-critical-module__body"]'
          );
        ...
        console.log('🚀 Payment modal blocker initialized');
